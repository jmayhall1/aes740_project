...
nc_file = Path("C:/Users/jmayhall/Downloads/aes740_project/tke/cm1out_icehurr_ext.nc")
output_dir = Path("C:/Users/jmayhall/Downloads/aes740_project/tke/ice_ext_photos/af")
...
for i in range(ql.shape[0]):
    ...
    mlab.savefig(f"C:/Users/jmayhall/Downloads/aes740_project/tke/ice_ext_photos/af/af_{i}.png")
