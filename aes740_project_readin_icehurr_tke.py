...
# Define file paths
nc_path = "C:/Users/jmayhall/Downloads/aes740_project/tke/cm1out_icehurr.nc"
output_dir = "C:/Users/jmayhall/Downloads/aes740_project/tke/ice_photos"

# Ensure output directories exist
variables_to_plot = ["qv", "dbz", "qi", "th", "rho", "xh", "yh", "zh"]
units_out = {'qv': 'Water Vapor Mixing Ratio (kg/kg)', 'dbz': 'Reflectivity (dBZ)', 'qi': 'Ice Mixing Ratio (kg/kg)',
...
plt.savefig('coocc_lineplot_ice.png', dpi=300)