...
nc_file = Path("C:/Users/jmayhall/Downloads/aes740_project/tke/cm1out_liqhurr.nc")
output_dir = Path("C:/Users/jmayhall/Downloads/aes740_project/tke/liq_photos/af")
...
for i in range(ql.shape[0]):
    ...
    mlab.savefig(f"C:/Users/jmayhall/Downloads/aes740_project/tke/liq_photos/af/af_{i}.png")
