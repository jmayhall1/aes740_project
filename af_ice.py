...
nc_file = Path("C:/Users/jmayhall/Downloads/aes740_project/no_tke/cm1out_icehurr.nc")
output_dir = Path("C:/Users/jmayhall/Downloads/aes740_project/no_tke/ice_photos/af")
...
for i in range(ql.shape[0]):
    ...
    mlab.savefig(f"C:/Users/jmayhall/Downloads/aes740_project/no_tke/ice_photos/af/af_{i}.png")
